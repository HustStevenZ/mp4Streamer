...
#define STREAM_USING_ADUS   //add by gavin 2011.12.23

DynamicRTSPServer*
DynamicRTSPServer::createNew(UsageEnvironment& env, Port our_port,
  ...
  return new DynamicRTSPServer(env, our_socket, our_port, uad, reclamation_test_seconds);
}
...
ServerMediaSession*
DynamicRTSPServer::lookupServerMediaSession(char const* streamName, Boolean isFirstLookupInSession) {
