...
subsession/%.o: ../subsession/%.cpp
	...
	g++ -I"/mnt/data/steven/workspace/2 MGV/live/liveMedia" -I"/mnt/data/steven/workspace/2 MGV/live/groupsock" -I"/mnt/data/steven/workspace/2 MGV/live/UsageEnvironment" -I"/mnt/data/steven/workspace/2 MGV/live/BasicUsageEnvironment" -I"/mnt/data/steven/workspace/2 MGV/live/UsageEnvironment/include" -I"/mnt/data/steven/workspace/2 MGV/live/groupsock/include" -I"/mnt/data/steven/workspace/2 MGV/live/BasicUsageEnvironment/include" -I"/mnt/data/steven/workspace/2 MGV/live/liveMedia/include" -I"/mnt/data/steven/workspace/2 MGV/live/ffmpegMediaServer/subsession" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
